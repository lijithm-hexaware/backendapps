...
using ShippingService.BusinessServices.Installer;

namespace ShippingService.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ShippingService API", Version = version + "-" + branch});
            });
